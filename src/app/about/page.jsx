        ...
        <div className="md:col-span-2">
          <div className="bg-white/3 p-6 rounded-lg shadow-sm mb-6">
            ...
            <p className="text-gray-300">
              I specialize in building interactive user interfaces using React,
              Next.js and WebGL. My focus is on performance, accessibility and
              thoughtful UX. Recently I have been exploring 3D components and
              transition driven experiences in the browser.
            </p>
          </div>
